...
class TestGenerateLabels:
    def test_generate_labels_returns_labels_as_array(self):
    ...
    def test_generate_labels_landscape_image_returns_labels_same_dimensions_as_original(self):
        input_image = Image.open(LANDSCAPE_TEST_IMAGE)
        img_array = np.array(input_image)
    ...
    def test_generate_labels_landscape_image_labels_dog_and_background(self):
        input_image = Image.open(LANDSCAPE_TEST_IMAGE)
        img_array = np.array(input_image)
    ...
    def test_generate_labels_portrait_image_returns_labels_same_dimensions_as_original(self):
    ...
    def test_generate_labels_landscape_image_labels_cat_and_background(self):
        input_image = Image.open(PORTRAIT_TEST_IMAGE)
        img_array = np.array(input_image)
